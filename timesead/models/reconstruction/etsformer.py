...
class FourierLayer(nn.Module):
    ...
    def topk_freq(self, x_freq):
        ...
        mesh_a, mesh_b = torch.meshgrid(range_0, range_2)
...
class ETSformer(BaseModel):
    ...
    def __init__(
        ...
        self.encoder = Encoder(
            [
                EncoderLayer(
                    model_dim, num_heads, input_dim, window_size, self.seq_len, top_k,
        ...
        self.decoder = Decoder(
            [
                DecoderLayer(
                    model_dim, num_heads, input_dim, self.seq_len,
                    dropout=dropout,
